...
def asift_main(image1: str, image2: str, detector_name: str = "sift-flann"):
    ...
    if isinstance(image1, str):
        ...
        ori_img1 = image1.copy()
        ori_img2 = image2.copy()
    ...
    vis = draw_match(
        "ASIFT Match Result", ori_img1, ori_img2, kp_pairs, None, H
    )  # Visualize result
    # cv2.waitKey()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="sift-flann",
        help="(sift|surf|orb|akaze|brisk)[-flann] Detector type to use, default as SIFT. Add '-flann' to use FLANN matching.",
    )
